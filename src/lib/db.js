...
Tỷ lệ dự đoán đúng kết quả chung cuộc (1X2) gần đây của bạn với 2 đội này là: {{rate}}% ({{correct}}/{{total}} trận đúng).`
      },
      {
        ...
        content: `Bạn là một Chuyên gia Phản biện Bóng đá và Soi kèo cực kỳ khắt khe. Dưới đây là bản nháp nhận định ban đầu cho trận đấu giữa {{homeTeam}} và {{awayTeam}}:
    ...
    if (!criticPromptExists || criticPromptExists.count === 0) {
      await dbInstance.run(
        ...
        [
          ...
          `Bạn là một Chuyên gia Phản biện Bóng đá và Soi kèo cực kỳ khắt khe. Dưới đây là bản nháp nhận định ban đầu cho trận đấu giữa {{homeTeam}} và {{awayTeam}}:
